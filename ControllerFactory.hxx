...
public:
	...
	AgentController* makeController(const std::string& controllerName, double mutationRate, std::string selectionProcess, std::string innovationProcess,int culturalStep);
};
